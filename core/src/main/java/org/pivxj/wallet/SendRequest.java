...
import org.hlmj.wallet.KeyChain.KeyPurpose;
import org.hlmj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.hlmj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.hlmj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
