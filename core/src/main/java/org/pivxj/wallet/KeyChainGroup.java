...
/**
 * <p>A KeyChainGroup is used by the {@link org.hlmj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.hlmj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.hlmj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.hlmj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
