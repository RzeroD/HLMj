...
import org.hlmj.core.*;
import org.hlmj.core.Message;
import org.hlmj.core.listeners.*;
import org.hlmj.core.TransactionConfidence.*;
import org.hlmj.crypto.*;
import org.hlmj.script.*;
import org.hlmj.signers.*;
import org.hlmj.utils.*;
import org.hlmj.wallet.Protos.Wallet.*;
import org.hlmj.wallet.WalletTransaction.*;
import org.hlmj.wallet.listeners.KeyChainEventListener;
import org.hlmj.wallet.listeners.ScriptsChangeEventListener;
import org.hlmj.wallet.listeners.WalletChangeEventListener;
import org.hlmj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.hlmj.wallet.listeners.WalletCoinsSentEventListener;
import org.hlmj.wallet.listeners.WalletEventListener;
import org.hlmj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.hlmj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.hlmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.hlmj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.hlmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.hlmj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.hlmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.hlmj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.hlmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.hlmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of hlmj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.hlmj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.hlmj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.hlmj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.hlmj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.hlmj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.hlmj.crypto.KeyCrypter,
     ...
     * {@link org.hlmj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.hlmj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.hlmj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.hlmj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.hlmj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.hlmj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
