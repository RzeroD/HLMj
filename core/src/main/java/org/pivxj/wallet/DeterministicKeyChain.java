...
import org.hlmj.core.BloomFilter;
 ...
 * {@link org.hlmj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.hlmj.crypto.MnemonicCode},
 ...
 * {@link org.hlmj.crypto.DeterministicKey#serializePubB58(org.hlmj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.hlmj.crypto.DeterministicKey#deserializeB58(org.hlmj.crypto.DeterministicKey, String, org.hlmj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.hlmj.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.hlmj.crypto.DeterministicHierarchy} and
 * {@link org.hlmj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from hlmj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.hlmj.crypto.DeterministicKey)}
     ...
     * @see org.hlmj.wallet.MarriedKeyChain
     */
