...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of hlmj fixes the known
     ...
     * {@link org.hlmj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.hlmj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.hlmj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.hlmj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.hlmj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.hlmj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.hlmj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.hlmj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.hlmj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a hlmj based app running in SPV mode to fully validating security.
     */
